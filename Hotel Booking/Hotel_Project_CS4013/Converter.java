...
{
    /**
 * Converts a Stirngs into an Int.
 */
 ...
 */
    default boolean convertToBoolean(String s){
        boolean n= false;
        try{
 ...
 */
    default LocalDate convertToDate(String y, String m, String d){
 ...
 */
    default Booking convertToBooking(String s){
